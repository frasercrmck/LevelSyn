...
Paths CClipperWrapper::FindIntersection(const CRoom &room1,
                                        const CRoom &room2) {
  Path p1, p2;
...
float CClipperWrapper::ComputeCollideArea(const CRoom &room1,
                                          const CRoom &room2) {
